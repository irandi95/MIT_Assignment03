...
public class EbaySearchTestBuyItNow extends BaseTest {
    ...
    @Test
    public void searchAndBuySpaCeylon() {
        ...
        // Read data
        String SpaCeylonBrand = excel.getCellData(1, 1); // Row 1, Column 1

        // Step 1: Search for SpaCeylon
        homePage.searchFor(SpaCeylonBrand);
        ...
        excel.setCellData(1, 2, "SpaCeylon Selected", excelFilePath);
